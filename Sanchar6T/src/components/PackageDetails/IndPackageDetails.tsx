...
// import temple from "../../assets/tirupati_2.jpg.jpeg";
...
//       const response = await fetch(`${API_BASE}/packages/${packageId}/full-details`);
...
// const getFallbackImage = (tourPkg: PackageItem) => {
//   switch (tourPkg.PackageID) {
//     case 1:
//       return temple;
//     default:
//       return temple;
...
//   return tourPkg.PackageImage || getFallbackImage(tourPkg);
// };
...
//                 <img src={temple} alt={pkg.PackageName} className="gallery-main-img" />
//               </div>

//               <div className="gallery-right-grid">
//                 <div className="gallery-small-card">
//                   <img src={temple} alt="Goa" className="gallery-small-img" />
//                 </div>
//                 <div className="gallery-small-card">
//                   <img src={temple} alt="Udupi" className="gallery-small-img" />
//                 </div>
//                 <div className="gallery-small-card">
//                   <img src={temple} alt="Kerala" className="gallery-small-img" />
//                 </div>
//                 <div className="gallery-small-card">
//                   <img src={temple} alt="Shirdi" className="gallery-small-img" />
//                   <button className="gallery-view-btn">View all</button>
//                 </div>
//               </div>
//             </div>

//             {showAvailability && (
//               <div className="availability-inline-wrap">
...
//                     <h4 className="starting-hour">{adults} Adult{adults > 1 ? "s" : ""}</h4>
//                   </div>
...
//                     ) : (
//                       <tr>
//                         <td colSpan={5}>No itinerary available.</td>
//                       </tr>
//                     )}
//                   </tbody>
//                 </table>
