        ...
        <div className="max-w-md">
         <img src={Logo} alt="Logo" className="h-32 w-32 mb-6" />
          ...
          <div className="space-y-6">
            <h1 className="text-6xl font-normal text-coming-soon-blue leading-tight">
              Coming Soon.
            </h1>
            ...
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start">
                <div className="w-2 h-2 bg-coming-soon-blue rounded-full mt-2 mr-3 flex-shrink-0"></div>
            ...
            <Button
              ...
              className="bg-brand-yellow hover:bg-brand-yellow/90 text-black font-medium px-12 py-3 rounded-full text-sm uppercase tracking-wider mt-8"
            >
              GO BACK
            </Button>
          </div>
